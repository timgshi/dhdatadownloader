...
DATABASES = {
    'default': {
        ...
        'HOST': 'mongodb://ds031627.mongolab.com',                      # Set to empty string for localhost. Not used with sqlite3.
...
STATIC_ROOT = os.path.join(os.path.dirname(__file__), 'main/static')
...
SECRET_KEY = '&v(5$!asb$^2v9$f1+q04)0j&$^=yx=_xr6qjq@e0+v)lh*sjf'
